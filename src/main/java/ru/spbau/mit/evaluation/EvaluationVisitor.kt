...
open class EvaluationVisitor(context: MutableContext) : ASTVisitor<EvaluationResult> {

    override fun visit(expressionStatement: ExpressionStatement): EvaluationResult {
